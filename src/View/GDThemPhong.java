 ...
 */
public class GDThemPhong extends javax.swing.JDialog {

    /**
     * Creates new form GDThemPhong
     */
    private GDTrangChu GDTC;
    public GDThemPhong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Giao diện thêm phòng");
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        if(new PhongDAO().addPhong(p)){
            JOptionPane.showMessageDialog(rootPane, "Them phong thanh cong");
            GDTC.ThemPhong(p);
            this.dispose();
        }else JOptionPane.showMessageDialog(rootPane, "bi trung ma phong -> yeu cau nhap lai");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GDThemPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GDThemPhong dialog = new GDThemPhong(new javax.swing.JFrame(), true);
